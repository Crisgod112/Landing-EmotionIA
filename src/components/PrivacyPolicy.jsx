...
const PrivacyPolicy = () => {
    ...
    return (
        <section id="privacidad" className="bg-gray-50 py-24">
            <div className="container mx-auto max-w-7xl px-6">
                ...
                <div className="space-y-8">
                    {sections.map((section, index) => (
                        <div key={index} className="rounded-lg border border-gray-200 bg-white p-8 shadow-sm transition-shadow duration-300 hover:shadow-lg">
                            ...
                            {section.list && (
                                <ul className="ml-4 space-y-2 text-gray-700">
                                    {section.list.map((item, idx) => (
                                        <li key={idx} className={item.startsWith('  •') ? "ml-6" : item.startsWith('Principales') || item.startsWith('Secundarias') ? "mt-3 font-semibold text-gray-900" : ""}>
                                            {item}
                                        </li>
                                    ))}
                                </ul>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        {rights.map((right, index) => (
                            <div key={index} className="flex items-start gap-3 rounded-lg bg-white p-4">
                                <div className="mt-1 text-xl text-secondary">✓</div>
                                <p className="text-gray-700">{right}</p>
                            </div>
                        ))}
                    </div>
                    <div className="mt-6 rounded-lg bg-white p-6">
                        <p className="mb-2 font-semibold text-gray-900">Para ejercer sus derechos ARCO, puede enviar una solicitud a:</p>
                        <p className="text-gray-700">
                            <strong>Correo electrónico:</strong> <a href="mailto:privacidad@upchiapas.edu.mx" className="text-primary hover:underline">privacidad@upchiapas.edu.mx</a>
                        </p>
                ...
                <div className="mt-12 space-y-6">
                    <div className="rounded-lg bg-white p-6 shadow-sm">
                        <h4 className="mb-3 text-xl font-semibold text-gray-900">Transferencia de Datos</h4>
                        <p className="text-gray-700">
                    ...
                    <div className="rounded-lg bg-white p-6 shadow-sm">
                        <h4 className="mb-3 text-xl font-semibold text-gray-900">Seguridad de los Datos</h4>
                        <p className="text-gray-700">
                    ...
                    <div className="rounded-lg bg-white p-6 shadow-sm">
                        <h4 className="mb-3 text-xl font-semibold text-gray-900">Cookies y Tecnologías de Rastreo</h4>
                        <p className="text-gray-700">
                    ...
                    <div className="rounded-lg bg-white p-6 shadow-sm">
                        <h4 className="mb-3 text-xl font-semibold text-gray-900">Cambios al Aviso de Privacidad</h4>
                        <p className="text-gray-700">
                    ...
                    <div className="rounded-lg bg-white p-6 shadow-sm">
                        <h4 className="mb-3 text-xl font-semibold text-gray-900">Consentimiento</h4>
                        <p className="text-gray-700">
                ...
                <div className="mt-12 border-t border-gray-300 pt-8 text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                        ...
                        <a href="https://home.inai.org.mx" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                            www.inai.org.mx
                        </a>
                    </p>
                </div>
